...
public class Ex09Electronics {
	...
	public Ex09Electronics() {}
	public Ex09Electronics(String modelNum, String modelName, int price, String description, String password) {
		super();
