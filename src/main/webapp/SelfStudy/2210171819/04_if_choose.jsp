...
<c:choose>
  <c:when test="${param.age>18}">
     <h4 style="color:blue">나이가 18보다 크면 성인입니다. 이용해주세요.</h4>
  </c:when>
  <c:otherwise>
      <h4 style="color:red"> ${param.age}살은 미성년자이므로 서비스를 이용할수없습니다.</h4>
  </c:otherwise>
</c:choose>
...
<!-- 
   1. 만약, name와 job 이 전송된다면 "~님 직업은 ~ 입니다." 출력
